...
function ob()
{
    ...
    container.innerHTML = '';
    var element = document.getElementById('zadacha10');
    element.innerHTML = 'Равновесие невращающихся тел';
    var element = document.getElementById('zadacha11');
    element.innerHTML = 'Центр масс. Центр тяжести';
    var element = document.getElementById('zadacha9');
    element.innerHTML = 'Движение спутников под действием сил тяготения';
    var element = document.getElementById('zadacha8');
    element.innerHTML = 'Вес тела';
    var element = document.getElementById('zadacha7');
    element.innerHTML = 'Движение тела, брошенного горизонтально под углом к горизонту';
    var element = document.getElementById('zadacha6');
    element.innerHTML = 'Силы трения скольжения, вязкого трения';
    var element = document.getElementById('zadacha5');
    element.innerHTML = 'Силы трения покоя';
    var element = document.getElementById('zadacha4');
    element.innerHTML = 'Закон всемирного тяготения';
    var element = document.getElementById('zadacha3');
    element.innerHTML = 'Закон Гука';
    var element = document.getElementById('zadacha2');
    element.innerHTML = 'Второй закон Ньютона для сил, действующих в пространстве(на плоскости)';
    var element = document.getElementById('zadacha1');
